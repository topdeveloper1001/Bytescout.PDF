...
namespace Bytescout.PDF
{
	...
	internal class UncoloredTilingPen : Pen
#else
	/// <summary>
    /// Represents an uncolored tiling pen.
    /// </summary>
	[ClassInterface(ClassInterfaceType.AutoDual)]
	public class UncoloredTilingPen : Pen
#endif
	{
	    ...
	    public UncoloredTilingPen(float width, float height)
	    {
		    if (width < 0)
        ...
        /// </summary>
        /// <returns cref="object" href="http://msdn.microsoft.com/en-us/library/system.object.aspx">Returns a shallow copy of this Bytescout.PDF.UncoloredTilingPen.</returns>
        public override object Clone()
        {
            UncoloredTilingPen p = this.MemberwiseClone() as UncoloredTilingPen;
        ...
        internal override void WriteChanges(Pen newPen, MemoryStream stream, Resources resources)
        {
            ...
            if (newPen is UncoloredTilingPen)
            {
                _pattern.WriteChangesForStroking((newPen as UncoloredTilingPen)._pattern, stream, resources);
            }
            else
